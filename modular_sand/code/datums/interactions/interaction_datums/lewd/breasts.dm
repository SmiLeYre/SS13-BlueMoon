...
/datum/interaction/lewd/titgrope/display_interaction(mob/living/carbon/human/user, mob/living/carbon/human/target)
	if(user.a_intent == INTENT_HELP)
		user.visible_message(
				pick("<span class='lewd'>\The <b>[user]</b> нежно ощупывает грудь \the <b>[target]</b>'s.</span>",
					 "<span class='lewd'>\The <b>[user]</b> мягко хватается за груди \the <b>[target]</b>'s.</span>",
					 "<span class='lewd'>\The <b>[user]</b> сжимает грудь \the <b>[target]</b>'s.</span>",
					 "<span class='lewd'>\The <b>[user]</b> проводит несколькими пальцами вдоль груди \the <b>[target]</b>'s.</span>",
					 "<span class='lewd'>\The <b>[user]</b> деликатно сжимает сосок \the <b>[target]</b>'s.</span>",
					 "<span class='lewd'>\The <b>[user]</b> возбуждённо проводит пальцем вдоль груди \the <b>[target]</b>'s.</span>"))
	if(user.a_intent == INTENT_HARM)
		user.visible_message(
				pick("<span class='lewd'>\The <b>[user]</b> с силой сжимает груди \the <b>[target]</b>'s.</span>",
					 "<span class='lewd'>\The <b>[user]</b> резко хватается за сиськи \the <b>[target]</b>'s!</span>",
					 "<span class='lewd'>\The <b>[user]</b> крепко сжимает грудь \the <b>[target]</b>'s.</span>",
					 "<span class='lewd'>\The <b>[user]</b> шлёпает по сиськам \the <b>[target]</b>'s!</span>",
					 "<span class='lewd'>\The <b>[user]</b> максимально грубо сжимает груди \the <b>[target]</b>'s.</span>"))
		...
		if(target.a_intent == INTENT_HELP)
			user.visible_message(
				pick("<span class='lewd'>\The <b>[target]</b> дрожит от возбуждения.</span>",
					 ...
					 "<span class='lewd'>\The <b>[target]</b> мурлыкает и звучно вздыхает.</span>",
			...
			if (target.restrained())
				user.visible_message(
					pick("<span class='lewd'>\The <b>[target]</b> игриво извивается в попытке снять физические ограничения.</span>",
						 ...
						 "<span class='lewd'>\The <b>[target]</b> толкает обнажённую грудь вперёд в руки <b>[user]</b>.</span>"))
			else
				user.visible_message(
					pick("<span class='lewd'>\The <b>[target]</b> игриво бьёт <b>[user]</b> по руке.</span>",
						 ...
						 "<span class='lewd'>\The <b>[target]</b> дразняще проводит несколькими пальцами <b>[user]</b> по своему соску.</span>"))
